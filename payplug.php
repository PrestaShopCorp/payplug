...
class Payplug extends PaymentModule
{
    ...
    public function getContent()
    {
        ...
        } elseif (Tools::getIsset('debug_mode')) {
            // toggle debug mode
    ...
    public function hookPaymentReturn()
    {
        ...
        if (isset($order->current_state) && $order->current_state == Configuration::get('PAYPLUG_ORDER_STATE_WAITING')) {
            ...
            $state = 'paid';
        } elseif (isset($order->current_state) && $order->current_state == Configuration::get('PAYPLUG_ORDER_STATE_WAITING_TEST')) {
